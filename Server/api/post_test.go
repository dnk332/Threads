...
func requireBodyMatchPost(t *testing.T, body *bytes.Buffer, post db.Post) {
	...
	require.Equal(t, post.CreatedAt, gotPost.CreatedAt)
	require.Equal(t, post.UpdatedAt, gotPost.UpdatedAt)
}

func requireBodyMatchPosts(t *testing.T, body *bytes.Buffer, accounts []db.Post) {
	data, err := io.ReadAll(body)
	require.NoError(t, err)
	...
	require.NoError(t, err)
	require.Equal(t, accounts, gotPosts)
}
